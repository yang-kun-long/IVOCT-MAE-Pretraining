...
def evaluate():
    ...
    print("\n" + "=" * 70)
    print("重建质量评估指标 (Reconstruction Quality Metrics)")
    print("=" * 70)
    ...
    print("\n参考标准:")
    print("  SSIM > 0.85: 优秀 | 0.70-0.85: 良好 | 0.50-0.70: 一般 | < 0.50: 较差")
    print("  PSNR > 30 dB: 优秀 | 25-30 dB: 良好 | 20-25 dB: 一般 | < 20 dB: 较差")
    print("=" * 70)
    ...
    import json
    with open(config.LOG_DIR / "evaluation_results.json", "w") as f:
        json.dump(results, f, indent=2)

    print(f"\n结果已保存到: {config.LOG_DIR / 'evaluation_results.json'}")
